	    ...
	    <div class="col-sm-12">
	        <div class="white-box">
                ...
                <div style="overflow: hidden;">
                    <h3 class="box-title pull-left">Listado de Cupones</h3> 
                    <button id="new_anuncio" class="btn btn-success pull-right">Nuevo Cupón</button>
                </div>
                <hr>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
	    ...
	    jQuery("#new_anuncio").on("click", function(e){
	    	show_modal('Cupones/new', {}, function(html, cerrar){
    ...
    function editar(id){
        show_modal('Cupones/edit/'+id, {}, function(html, cerrar){
            cerrar(html);
        }, true);  
    }

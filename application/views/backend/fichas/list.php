	    ...
	    <div class="col-sm-12">
	        <div class="white-box">
                ...
                <div style="overflow: hidden;">
                    <h3 class="box-title pull-left">Listado de Paquetes de Fichas</h3> 
                    <button id="new_anuncio" class="btn btn-success pull-right">Nuevo Paquete</button>
                </div>
                <hr>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
        table = jQuery('#_table').DataTable({
            ...
            "ajax": {
                "url": "<?= base_url( 'Fichas/list' ) ?>",
                "type": "POST"
            }
        });

	    jQuery("#new_anuncio").on("click", function(e){
	    	show_modal('Fichas/new', {}, function(html, cerrar){
    ...
    function editar(anuncio){
        ...
        show_modal('Fichas/edit/'+anuncio, params, function(html, cerrar){
            console.log(html);
    		cerrar();
    	}, true);  
    }

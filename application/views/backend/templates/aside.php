<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        <ul class="nav" id="side-menu">
            ...
            <li> <a href="<?= base_url('Administrador/anuncios') ?>" class="waves-effect"><i class="fa fa-bullhorn p-r-10"></i> <span class="hide-menu"> Pujas </span></a> </li>
            ...
            <li> <a href="<?= base_url('Administrador/usuarios') ?>" class="waves-effect"><i class="fa fa-users p-r-10"></i> <span class="hide-menu"> Usuarios </span></a> </li>

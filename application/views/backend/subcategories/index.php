<section id="content">
          <section class="vbox">
            <header class="header bg-white b-b b-light">
              <a href="<?= base_url('admin/subcategories/add')?>" class="btn btn-s-md btn-success btn-rounded">Crear Subcategoria</a>
            </header>
                ...
                <div class="table-responsive">
                  ...
                  <table class="table table-striped b-t b-light" id="table_data">
                    ...
                    <tbody>
                      ...
                      <?php foreach ($subcategories as $d): ?>
                      <tr>
                        ...
                        <td>
                          <div class="btn-group">
                            ...
                            <ul class="dropdown-menu pull-right">
                              <li><a href="<?= base_url('admin/subcategories/edit/'.$d['id_subcategoria'])?>">Editar</a></li>
                              <li class="divider"></li>
                              <li><a href="javascript:;" onclick="eliminar(<?= $d['id_subcategoria']?>);">Borrar</a></li>
                            </ul>
                          </div>
                        </td>
                      </tr>
...
<div class="modal fade" id="borrar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <form action="<?php echo base_url()?>admin/subcategories/delete" method="POST">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          <h4 class="modal-title">Eliminar Subcategoría</h4>
        </div>
        <div class="modal-body">
          <p>En realidad deseas eliminar esta subcategoría? </p>

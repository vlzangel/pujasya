    ...
    <div class="container">
     <!--  <p class="navegar_filtro">Estás en: <a href="<?= base_url('anuncios/'.$anuncio['cat_seo'])?>" title="<?= $anuncio['categoria'] ?>"><?= $anuncio['categoria'] ?></a> | <a href="<?= base_url('anuncios/'.$anuncio['cat_seo'].'/'.$anuncio['subcat_seo'])?>" title="<?= $anuncio['subcategoria'] ?>"><?= $anuncio['subcategoria'] ?></a></p> -->
      <div class="row row-rl-10 row-tb-20">
          <h1 class="mb-10 mt-30 h3"><strong>
           <?= applib::titulo($anuncio['titulo'])?>
           <div id="fb-root"></div></strong>
           </h1>
            ...
            <div class="col-xs-12">
              ...
              <div class="deal-deatails panel">
                <div class="text-right p-20" >
                  <span id="favoritos_span_<?= $a['id_anuncio']?>">
                      <a href="javascript:;" onclick="favoritos_listado(<?= $a['id_anuncio']?>)"><i class="fa fa-heart" style="font-size:30px;"></i></a>
                  </span>
                </div>
                ...
                <div class="deal-slider">
                  <div id="product_slider" class="flexslider">
                    ...
                    ?>
                      ...
                      <!-- </li> -->
                      <li style="background-image: url(<?= base_url()?>public/uploads/anuncios/thumb/<?= $img['name']?>);height: 522px; background-position: center;background-repeat: no-repeat;background-size: contain;">
                    ...
                    <ul class="slides">
                     <?php 
                        if(count($imagenes) > 0):
                            foreach ($imagenes as $img):
                    ?>
                      <li style="background-size:contain; background-position: center;background-repeat: no-repeat;background-image: url(<?= base_url()?>public/uploads/anuncios/thumb/<?= $img['name']?>);height:188.25px;width: 188.25px !important;background-size:cover;">
                           ...
                           <!--  <div class="text-left mt-20 pl-15">
                            ...
                            <div class="mt-30">
                              ...
                              <div class="row rsinmlf fila">
                                  ...
                                  <div class="col-md-4 col-xs-6">
                                     <h5 class="text-right" style="font-weight: 700;">578€</h5>
                                  </div>
                              ...
                              <div class="row rsinmlf fila">
                                ...
                                <div class="col-md-4 col-xs-6">
                                   <h5 class="text-right">12:30 - 6:30</h5>
                                </div>
                              </div>
                            ...
                            <div class="mt-40">
                                ...
                                <div class="row rsinmlf fila">
                                    ...
                                    <div class="col-md-4 col-xs-6">
                                       <h5 class="text-right" style="font-weight: 700;">0.68€</h5>
                                    </div>
                                </div>
                                ...
                                <div class="row rsinmlf fila" style="border-bottom: 0;">
                                      ...
                                      <div class="col-md-4 col-xs-6">
                                         <h5 class="text-right" style="font-weight: 700;">100€</h5>
                                      </div>
                                    </div>
                              </div>

...
<div class="container splr" style="padding-left: 0;">
  ...
  <div class="col-md-12 mt-30 splr">
     <img class="img-responsive" src="http://26projects.com/wp-content/uploads/2017/05/Sept-23-1786-Advance-Electronics-Great-Fall-Sale-Banners-V1_resized.jpg" alt="">
  </div>
              ...
              <div class="col-md-4 col-sm-4 col-xs-12 plr-2 ctr">
                <div class="row">
                  ...
                  <div class="col-md-8 pt-20">
                     <a class="atitle" href="<?= base_url('anuncio/'.$p['seo'])?>" title="<?= $p['titulo']?>"><?= applib::titulo(substr($p['titulo'], 0,23))?><?= (strlen($p['titulo']) > 23)?'...':''?></a>
